...
export function IncludedIcon({ name }: { name: string }) {
  switch (name) {
    ...
    case "globe":
      // Globe — generic "the web" icon for live web access. Distinct
      // from the Chrome browser icon (authenticated browsing): this is
      // about real-time HTTP fetch, not driving a headed browser.
