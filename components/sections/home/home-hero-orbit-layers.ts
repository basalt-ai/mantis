 ...
 * **Widths:** `tokens.css` — orbit 1 from cream `428:16771`; orbits 2–6 = orbit 1 × (Oᵢ/O₁); layout adds `2×--size-home-hero-orbit-radius-add` to each ring width (ellipse unchanged). Angles: −`node.rotation`.
 */
