...
faq:
  ...
  - question: "What is Pancake?"
    answer: "Pancake is a Slack-native AI co-founder platform. For $49/month, you get an AI workforce — agents handling growth, engineering, and operations — that runs in your Slack, knows your company, and works while you sleep."
...
Pancake is a Slack-native AI co-founder platform. For $49/month, you get an AI workforce — agents handling growth, engineering, and operations — that runs in your Slack, knows your company, and works while you sleep.

These aren't chatbots you prompt. They're agents with memory, skills, and schedules. The harness is built in.

We're in alpha with a small group of founders right now. If you want to wake up to work already done, that's what we're building.
